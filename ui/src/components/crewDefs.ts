...
export const crewDefs: CrewDef[] = [
    ...
    // ───────────────────── CREW 1 — Verbas ALBA (RESTAURADA) ─────────────────────
    {
        ...
        agents: [
            ...
            {
                id: 'dunga',
                name: 'Dunga: O Escritor Gold',
                role: 'Consolidador de Dados Ouro',
                tech: 'python',
                description: 'O cérebro final do pipeline. Ele pega os dados purificados pelo Bebeto e auditados pelo Kaká para criar o Registro de Ouro (Golden Record) e persistir tudo no banco de dados Supabase.',
                howItWorks: [
                    'Consolidação Final: Resolve conflitos entre dados do portal e dados extraídos das notas.',
                    'Carga no Supabase: Realiza o upsert final na tabela despesas_gabinete garantindo integridade e sem duplicidade.',
                    'Relatório de Saúde: Gera o relatório final de quanto foi recuperado ou auditado com sucesso.',
                ],
                libs: ['supabase-py', 'json', 'datetime'],
